...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q1_75] = {
        .type_name                = "q1_75",
        .blck_size                = QK1_75,
        .type_size                = sizeof(block_q1_75),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_q1_75,
        .from_float_ref           = (ggml_from_float_t) quantize_row_q1_75_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
...
enum ggml_type ggml_ftype_to_ggml_type(enum ggml_ftype ftype) {
    ...
    switch (ftype) {
        ...
        case GGML_FTYPE_MOSTLY_Q1_75:         wtype = GGML_TYPE_Q1_75; break;
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_Q1_75:   result = quantize_q1_75  (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
